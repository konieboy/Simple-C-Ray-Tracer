...
Scene * Scene::initTestScene2(int N, int fov){
    ...
    test->ambient = Color(0.4,0.25,0.25,1.0);
    test->diffuse = Color(0.3,0.6,0.6,1.0);
    test->specular = Color(0.2,0.2,0.2,1.0);
    ...
    sphere->ambient = Color(0.23,0.22,0.12,1.0);
    sphere->diffuse = Color(0.33,0.12,0.12,1.0);
    sphere->specular = Color(0.12,0.45,0.12,1.0);
    Object * s1 = new Sphere(Point(400.0,130.0,320.0),120.0);
    // Make points for square
    Point p1 = Point(0,0,0);
    Point p2 = Point(550,0,0);
